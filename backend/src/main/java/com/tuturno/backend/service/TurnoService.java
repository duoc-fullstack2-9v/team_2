...
public class TurnoService {
    ...
    public Turno crearTurno(Long usuarioId,
        ...
        List<Turno> solapados =
                turnoRepository.findByUsuarioIdAndInicioTurnoLessThanEqualAndFinTurnoGreaterThanEqual(
                        usuarioId,
                        finTurno,
                        inicioTurno
                );
        ...
        if (!solapados.isEmpty()) {
            throw new IllegalStateException("El turno se solapa con otro existente.");
        }
    ...
    public Turno actualizarTurno(Long turnoId,
                             Long usuarioId,
                             LocalDateTime inicioTurno,
                             LocalDateTime finTurno,
                             String titulo,
    ...
    List<Turno> solapados =
            turnoRepository.findByUsuarioIdAndIdNotAndInicioTurnoLessThanEqualAndFinTurnoGreaterThanEqual(
                    usuarioId,
                    turnoId,
                    finTurno,
                    inicioTurno
